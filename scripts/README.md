...
1. **Add authentication to `.env.local`**:
   ```env
   COHET_COOKIES="your-cookie-string-here"
   ```
...
1. Ensure you're logged into Cohet AI in your browser
2. Get fresh cookies from DevTools
3. Update `COHET_COOKIES` in `.env.local`
...
- Verify `.env.local` exists and contains `COHET_COOKIES`
