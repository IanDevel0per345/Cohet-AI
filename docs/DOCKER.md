...
- **Cohet AI** - The application

## Model Selection

In Docker mode, Cohet AI dynamically detects available AI providers based on your API keys and displays a model selector in the UI. No configuration files to edit — just set your API key and pick your model.
...
```bash
POSTGRES_USER=cohet      # Default: cohet
POSTGRES_PASSWORD=cohet  # Default: cohet
POSTGRES_DB=cohet        # Default: cohet
...
# View logs
docker compose logs -f cohet

# Rebuild the image
docker compose build cohet
```
